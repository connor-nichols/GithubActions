[![Run App Nichols](https://github.com/connor-nichols/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/connor-nichols/GithubActions/actions/workflows/run-app.yaml)
